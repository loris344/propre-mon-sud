            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="text-center">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl">Désinfection Virale</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="text-center">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl">Désinfection Bactérienne</CardTitle>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2 text-left text-muted-foreground">
                    <li className="flex items-center gap-2">
              ...
              <Card className="text-center">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl">Insalubrité & Nuisances</CardTitle>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2 text-left text-muted-foreground">
                    <li className="flex items-center gap-2">
