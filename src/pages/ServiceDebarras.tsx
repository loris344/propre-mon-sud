  ...
  return (
    <>
      ...
      <CityHero
        ...
        description={`Évacuation et tri de tous types d'objets, meubles et déchets en respectant l'environnement. Service professionnel pour particuliers et professionnels à ${cityName} et sa région.`}
      />
      ...
      <CityGallery
        cityName={cityName}
        pathname={location.pathname}
        title={`Débarras Professionnel à ${cityName}`}
        description={`Découvrez nos services de débarras et évacuation à ${cityName}. Tri sélectif et respect de l'environnement garantis.`}
      />
