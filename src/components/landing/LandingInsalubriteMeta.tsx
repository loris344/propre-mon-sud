        ...
        <div className="container mx-auto px-4 sm:px-6 relative">
          <div className="max-w-2xl mx-auto text-center mb-8 sm:mb-10 space-y-4">
            ...
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
              Désinfection, débarras et remise en état de logements insalubres. Intervention discrète en{" "}
          ...
          <div className="grid lg:grid-cols-2 gap-6 max-w-5xl mx-auto items-start">
            ...
            <div id="devis-gratuit" className="scroll-mt-24">
              <img
                ...
                height={450}
              />
              <ContactForm onSuccess={() => trackMetaLead("insalubrite")} />
            </div>
          </div>
        </div>
      </section>
...
export default LandingInsalubriteMeta;
