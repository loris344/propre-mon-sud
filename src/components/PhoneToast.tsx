...
const PhoneToast = () => {
  ...
  // Landing pages Meta Ads : aucun numéro affiché nulle part sur ces pages,
  // le formulaire est le seul canal de conversion suivi.
  if (isMetaLandingPage(pathname)) return null;
